...
class SimpleDWBNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('goal_yaw_kp', 0.8)
        self.declare_parameter('eps', 1e-6)

        # --------------------------------------------------
        # Parameters: robot limits
        # --------------------------------------------------
        self.declare_parameter('max_vel_x', 0.60)
        self.declare_parameter('min_vel_x', 0.00)
        self.declare_parameter('max_vel_theta', 0.60)
        ...
        self.declare_parameter('sim_time', 0.48)
        self.declare_parameter('sim_dt', 0.08)
        self.declare_parameter('vx_samples', 15)
        self.declare_parameter('wz_samples', 17)
        ...
        self.declare_parameter('obstacle_influence_dist', 0.60)
        self.declare_parameter('w_path', 5.5)
        self.declare_parameter('w_goal', 1.01)
        self.declare_parameter('w_heading', 0.08)
        self.declare_parameter('w_obstacle', 0.05)
        self.declare_parameter('prefer_forward', 0.75)
    ...
    def _build_dynamic_window(self, local_goal=None):
    ...
    def _select_best_cmd(self, local_pts: np.ndarray, local_goal):
        ...
        v_samples, w_samples = self._build_dynamic_window(local_goal)
