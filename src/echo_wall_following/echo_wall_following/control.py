...
class WallFollowerControl(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('max_steering', 2.2)  # Límite de dirección
    ...
    def front_callback(self, msg):
        ...
        if msg.linear.x < 2.5 and msg.linear.y > 1.0 and self.diagiz > self.dist_min:
            self.front_yaw = 0.6 * msg.linear.y + 0.65/(msg.linear.x*msg.linear.x)
